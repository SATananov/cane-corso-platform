...
function mapReviewQueueRow(row: ReviewQueueRow): ReviewQueueItem {
  return {
    ...
    owner: {
      ...
      firstName: row.ownerProfile.firstName,
      middleName: row.ownerProfile.middleName,
      lastName: row.ownerProfile.lastName,
      avatarUrl: row.ownerProfile.avatarUrl,
      email: row.ownerUser.email,
      phone: row.ownerProfile.phone,
      city: row.ownerProfile.city,
      country: row.ownerProfile.country,
      addressLine: row.ownerProfile.addressLine,
      websiteUrl: row.ownerProfile.websiteUrl,
      bio: row.ownerProfile.bio,
    },
