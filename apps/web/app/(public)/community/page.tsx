...
const copyByLocale = {
  en: {
    ...
    worldsDescription:
      'These are the most valuable storiche ideas to keep inside the new architecture so the platform feels human, useful, and revisitable.',
    worlds: [
      {
        eyebrow: 'FUN • media',
      ...
      {
        eyebrow: 'Area riproduzione',
        title: 'Match logic belongs in community, not in the official trust core',
        description: 'Future abbinamento flow can support owners and breeders without confusing it with registry publication or certificate trust.',
        icon: 'community',
      },
      {
        eyebrow: 'Nuova casa',
        title: 'Supportive rehoming deserves a dignified place',
        description: 'A nuova casa section helps the platform serve real Cane Corso needs with care, moderation, and humane visibility.',
        icon: 'owner',
      },
      {
        eyebrow: 'Guida proprietario',
        title: 'Useful community should stay connected to practical owner guidance',
        description: 'Community becomes stronger when it connects directly to aiuto al proprietario, conoscenze, FAQ, and clear publication rules.',
        href: '/knowledge',
        meta: 'Guida proprietario • FAQ • help',
        icon: 'knowledge',
      },
      {
        ...
        href: '/registry',
        meta: 'Editorial • presenza d’élite • evidenza premium',
        icon: 'elite',
      },
      {
  ...
  it: {
    eyebrow: 'Centro comunità',
    title: 'Cane Corso cerca: casa, abbinamento, aiuto e luoghi',
    description:
      'Si parte dal bisogno reale: abbinamento, nuova casa, cuccioli, Cane Corso smarriti o trovati, luoghi adatti e servizi fidati. Ogni annuncio pubblico resta revisionato e i collegamenti sensibili passano dall’amministratore.',
    cards: [
      {
        eyebrow: 'Media',
        title: 'Galleria, momenti e presenza editoriale',
        description: 'Un livello pubblico premium per momenti Cane Corso, editoriali, eventi e media della comunità che rende viva la piattaforma.',
        href: '#cane-corso-intent-listings',
      ...
      {
        eyebrow: 'Breeding & match',
        title: 'Futura logica abbinamento con contesto owner',
        description: 'Un layer curato di abbinamento e breeding può esistere come layer community moderato, chiaramente separato dall’official registry trust.',
        href: '#cane-corso-intent-listings',
      ...
      },
      {
        ...
        description: 'La logica nuova casa dovrebbe supportare visibilità, cura e moderazione affidabile quando un Cane Corso ha bisogno di un ambiente migliore.',
        href: '#cane-corso-intent-listings',
        meta: 'Nuova casa • cura • moderazione',
        icon: 'owner',
      },
    ] satisfies readonly PageShellCard[],
    worldsTitle: 'Mondi della comunità da preservare dal vecchio progetto',
    worldsDescription:
      'Queste sono le idee storiche più preziose da tenere nella nuova architettura così la piattaforma resta umana, utile e degna di essere visitata di nuovo.',
    worlds: [
      {
        eyebrow: 'FUN • media',
        title: 'Media e galleria dovrebbero sembrare un vero livello pubblico',
      ...
      {
        eyebrow: 'Area riproduzione',
        title: 'La logica abbinamento appartiene al layer community, non al nucleo official trust',
        description: 'Il futuro abbinamento flow può aiutare proprietari e allevatori senza essere confuso con la pubblicazione nel registro o la fiducia del certificato.',
        icon: 'community',
      },
      {
        eyebrow: 'Nuova casa',
        title: 'Il rehoming di supporto merita un posto dignitoso',
        description: 'La sezione nuova casa aiuta la piattaforma a servire bisogni reali del Cane Corso con cura, moderazione e visibilità umana.',
        icon: 'owner',
      },
      {
        eyebrow: 'Guida proprietario',
        title: 'La comunità utile dovrebbe restare collegata alla guida pratica per il proprietario',
        description: 'La community diventa più forte quando si collega direttamente a aiuto al proprietario, conoscenze, FAQ e regole di pubblicazione chiare.',
        href: '/knowledge',
        meta: 'Guida proprietario • FAQ • aiuto',
        icon: 'knowledge',
      },
      {
        ...
        href: '/registry',
        meta: 'Editoriale • presenza d’élite • evidenza premium',
        icon: 'elite',
      },
      {
        eyebrow: 'Luoghi e servizi',
        title: 'La visibilità approvata rende l’ecosistema pratico',
        description: 'Luoghi per passeggiare, trasporto, pensione, luoghi adatti ai cani e servizi approvati rendono la piattaforma utile nella vita quotidiana.',
        icon: 'partners',
      },
    ],
    moderationTitle: 'Perché anche questo livello ha ancora bisogno di moderazione',
    moderationDescription:
      'Comunità non significa caos. Il vecchio progetto era più forte quando bilanciava energia e disciplina. La nuova versione mantiene lo stesso principio: la visibilità utile dovrebbe sembrare comunque curata, approvata e allineata all’identità del marchio.',
    moderationBullets: [
      'La fiducia ufficiale resta nel registro, nella verifica e decisioni sul certificato.',
      'I livelli della comunità espandono utilità, attività e valore per il proprietario senza fingersi fonte ufficiale di verità.',
      'Ogni contenuto pubblico dovrebbe comunque passare da revisione prima di diventare visibile.',
    ],
  },
} as const;
