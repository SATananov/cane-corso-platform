...
const copyByLocale = {
  ...
  bg: {
    ...
    helpLabel: 'Помощ',
    heroNote: 'Тук се отварят само реални публикувани записи. Чернови, чакащи записи, само одобрени записи и вътрешни предложения остават частни или само за администратор.',
    featured: 'Отличен',
  ...
  it: {
    ...
    helpLabel: 'Aiuto',
    heroNote: 'Qui si aprono solo schede reali e pubblicate. Bozze, schede in revisione, approvate ma non pubblicate e suggerimenti interni restano privati o solo per amministratore.',
