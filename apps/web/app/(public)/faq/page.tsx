...
const copyByLocale: Record<'en' | 'bg' | 'it', FaqCopy> = {
  en: {
    ...
    cards: [
      { eyebrow: 'Platform map', title: 'Every public surface has a separate role', description: 'Registry, Certificate, Verify, Gallery, Community, Partners, and Knowledge are connected, but they do not mean the same thing.', href: '#platform-map', meta: 'USG • Регистър • Знания', icon: 'platform' },
    ...
    sections: [
      ...
      { id: 'gallery-community-partners', eyebrow: '04 / Галерия + Общност + Партньори', title: 'Public presence, help requests, and services', description: 'The platform separates beauty, usefulness, and sensitive contact.', items: [
      ...
      { id: 'knowledge-bulgarico', eyebrow: '05 / Знания + Bulgarico', title: 'Breed education, official sources, and USG observations', description: 'Knowledge teaches; it does not replace official standards or professional advice.', items: [
  ...
  bg: {
    ...
    sections: [
      ...
      { id: 'privacy-safety', eyebrow: '06 / Поверителност + безопасност', title: 'Публична видимост и модерация', description: 'Доверието има нужда от граници, не само от дизайн.', items: [
        { question: 'Кой решава какво става публично?', answer: 'Публичната видимост се контролира от платформения процес и админ преглед. Заявките от собственици, общностните записи, партньорските кандидатури и състоянията на доверие не трябва автоматично да се превръщат в публична власт.' },
  ...
  it: {
    ...
    cards: [
      { eyebrow: 'Mappa piattaforma', title: 'Ogni superficie pubblica ha un ruolo separato', description: 'Registro, Certificato, Verifica, Galleria, Comunità, Partner e Conoscenze sono collegati, ma non significano la stessa cosa.', href: '#platform-map', meta: 'USG • Регистър • Знания', icon: 'platform' },
    ...
    sections: [
      ...
      { id: 'gallery-community-partners', eyebrow: '04 / Галерия + Общност + Партньори', title: 'Presenza pubblica, richieste di aiuto e servizi', description: 'La piattaforma separa bellezza, utilità e contatto sensibile.', items: [
      ...
      { id: 'knowledge-bulgarico', eyebrow: '05 / Знания + Bulgarico', title: 'Educazione razza, fonti ufficiali e osservazioni USG', description: 'Knowledge educa; non sostituisce standard ufficiali o valutazioni professionali.', items: [
