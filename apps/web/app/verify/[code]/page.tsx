  ...
  const copyByLocale = {
    ...
    bg: {
      ...
      cards: [
        ...
        { eyebrow: 'Наръчник', title: 'Ползвай наръчника за пълното trust обяснение', description: 'Наръчникът обяснява заедно публикацията в Регистъра, членската подготовка, модерацията и сертификатното доверие.', href: '/guide?topic=registry#registry', meta: 'Наръчник • trust слоеве', icon: 'guide' as const },
        { eyebrow: 'Път на собственика', title: 'Собствениците пак работят първо от частната членска зона', description: 'Работата по профила започва в My Dogs и Profile много преди verify да стане релевантен.', href: '/my-dogs', meta: 'Подготовка на собственика • частна зона', icon: 'member' as const },
      ],
    },
    it: {
