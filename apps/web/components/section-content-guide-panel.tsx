...
const bg: ContentMap = {
  ...
  certified: {
    ...
    nextHref: '/verify',
    nextText: 'Когато имаш код, използвай Проверка за потвърждение на активния запис.',
  },
  verify: {
    eyebrow: 'Как работи проверката',
    title: 'Проверката потвърждава активен сертификатен запис',
    description:
    ...
    cards: [
      ...
      { label: 'Граница', title: 'Проверката не оценява всички Cane Corso', body: 'Ако кучето няма сертификат, това не значи автоматично, че не е истинско Cane Corso.' },
  ...
  knowledge: {
    eyebrow: 'Какво има в Знания',
    title: 'Знания е образователният център за Cane Corso и USG идеята',
    description:
  ...
  faq: {
    ...
    cards: [
      ...
      { label: 'Следваща стъпка', title: 'Отговорът води към действие', body: 'След всеки основен въпрос трябва да знаеш дали да отвориш профил, Знания, Общност или админ секция.' },
    ],
  ...
  community: {
    ...
    nextHref: '/ecosystem',
    nextText: 'Личните заявки се управляват от членската зона, а публичността идва след преглед.',
  },
  partners: {
  ...
  member: {
    ...
    title: 'Членският център показва действията, които са важни след вход',
    description:
  ...
  ecosystemWorkspace: {
    ...
    description:
      'Членската зона за екосистемата пази статуса на всяка заявка: чернова, изпратена, върната, одобрена, публикувана или архивирана.',
    cards: [
  ...
  partnerApply: {
    ...
    cards: [
      ...
      { label: 'Доверие', title: 'Одобрението минава през админ', body: 'Публичната видимост идва само след проверка и не трябва да се смесва с общностна популярност.' },
  ...
  adminDashboard: {
    ...
    description:
      'Тази секция води към профили за преглед, контрол на Регистъра, партньори, екосистемни заявки, Знания и потребители.',
    cards: [
  ...
  review: {
    ...
    title: 'Прегледът е мястото за човешка преценка преди публичност',
    description:
    ...
    nextLabel: 'Отвори контрол на Регистъра',
  ...
  adminRegistry: {
    ...
    cards: [
      { label: 'Публично', title: 'Всяка промяна се вижда навън', body: 'Публикуван профил влияе на Регистър, Проверка, Галерия и доверените повърхности.' },
      ...
      { label: 'Връщане назад', title: 'Отнемането също е сериозно действие', body: 'Сваляне от Регистъра или отнемане на сертификат трябва да има причина и следа.' },
    ],
  ...
  adminKnowledge: {
    eyebrow: 'Админ контрол на Знания',
  ...
  adminMembers: {
    ...
    description:
      'Тази зона трябва да помага за преглед на ролите член / админ / партньор, собствеността върху профили и безопасната работа с данни.',
    cards: [
      { label: 'Роли', title: 'Ролята определя достъпа', body: 'Член, партньор и админ не трябва да виждат едни и същи действия.' },
