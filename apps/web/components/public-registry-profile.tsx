...
const copyByLocale = {
  en: {
    labels: {
      ...
      guestPreviewDescription:
        'Other visitors see only approved photos, the Cane Corso name, birth date, and the owner public name. Full owner data and deeper Cane Corso details stay visible only to the owner and admin.',
  ...
  bg: {
    labels: {
      ...
      publicEssentialsDescription: 'Този публичен профил в Регистъра показва само одобреното безопасно ядро: снимки, име на Cane Corso, дата на раждане и публично име на собственика. Пълните данни за собственика и по-дълбоките данни за Cane Corso остават видими само за собственика и админ.',
      ...
      privateRegistryDetailsDescription: 'Виждаш разширените данни от Регистъра, защото си собственикът или админ. Другите посетители получават само одобреното публично ядро.',
  ...
  it: {
    labels: {
      ...
      publicEssentialsDescription: 'Questo profilo pubblico nel Registro mostra solo il nucleo sicuro approvato: foto, nome del Cane Corso, data di nascita e nome pubblico del proprietario. I dati completi del proprietario e i dettagli più profondi del Cane Corso restano visibili solo al proprietario e all’admin.',
      ...
      privateRegistryDetailsDescription: 'Vedi i dati estesi del Registro perché sei il proprietario o un admin. Gli altri visitatori ricevono solo il nucleo pubblico approvato.',
