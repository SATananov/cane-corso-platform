...
const copyByLocale = {
  ...
  bg: {
    ...
    next: {
      ...
      certified: 'Поддържай сертификатния слой на доверие последователен в регистъра, проверката и представителните повърхности.',
    ...
    cards: [
      {
        ...
        description: '„Моите Cane Corso“ остава мястото за подготовка, дори когато един Cane Corso по-късно стане публичен.',
        href: '/my-dogs',
        meta: 'Лични профили • медия • родословие',
      },
      {
      ...
      },
      {
        ...
        href: '/ecosystem',
        meta: 'Заявки от собственици • прегледана видимост',
      },
    ],
  },
  it: {
    eyebrow: 'Centro comando membro',
    title: 'Un percorso del proprietario chiaro dal profilo privato alla fiducia pubblica',
    description:
      'Questo pannello collega il spazio Cane Corso privato con revisione, registro, fiducia del certificato e possibilità di presentazione senza cambiare la logica di approvazione.',
    identity: 'Panoramica percorso proprietario',
    nextAction: 'Prossima azione consigliata',
    open: 'Apri',
    manage: 'Gestisci',
    review: 'Percorso revisione',
    dogs: 'Profili Cane Corso',
    ecosystem: 'Voci ecosistema',
    noDogs: {
      title: 'Inizia con il tuo primo profilo Cane Corso privato',
      description: 'Crea prima il profilo in privato. Revisione, pubblicazione nel registro, certificato e presentazione restano passaggi separati.',
      href: '/my-dogs/new',
      label: 'Crea profilo',
    },
    next: {
      needsChanges: 'Correggi le note restituite dalla revisione prima di inviare di nuovo.',
      drafts: 'Completa le bozze private prima di mandarle in revisione.',
      review: 'Segui lo stato della revisione e attendi la decisione amministrativa prima dei livelli pubblici di fiducia.',
      published: 'Controlla la presenza pubblica nel registro e rafforza media, pedigree e presentazione.',
      certified: 'Mantieni coerente il livello certificato tra registro, verifica e presentazione.',
    ...
    labels: {
      ...
      certificatePending: 'Decisione amministrativa separata',
    ...
    milestones: {
      ...
      reviewReady: 'Almeno un profilo è già nel percorso di revisione.',
      reviewAttention: 'Uno o più profili richiedono correzioni del proprietario.',
      reviewLocked: 'Invia un profilo privato completo prima della revisione.',
      ...
      certificateLocked: 'La fiducia certificata resta una decisione amministrativa separata.',
      showcaseReady: 'Record pubblicati/certificati possono essere considerati per la visibilità di presentazione premium.',
      showcaseLocked: 'La valutazione Galleria/presentazione inizia dopo una qualità pubblica reale.',
    },
    status: {
      draft: 'Bozza',
    ...
    cards: [
      {
        ...
        title: 'Il spazio del proprietario resta personale',
        description: 'I miei Cane Corso resta l’area di preparazione privata anche quando un Cane Corso diventa pubblico più tardi.',
        href: '/my-dogs',
        meta: 'Profili privati • media • pedigree',
      },
      {
        eyebrow: 'Livello ufficiale',
        title: 'Registro e verifica restano separati',
        ...
        href: '/registry',
        meta: 'Registro • certificato • verifica',
      },
      {
        eyebrow: 'Livello comunità',
        title: 'L’ecosistema cresce dopo revisione',
        description: 'Luoghi, servizi, trasporti, eventi e opportunità possono essere inviati senza superare la moderazione.',
        href: '/ecosystem',
        meta: 'Richieste dei proprietari • visibilità revisionata',
      },
    ],
  },
} as const;
