...
const copyByLocale = {
  en: {
    ...
    evidenceKeys: {
      ...
      sex_needed_for_standard_range: 'sex needed for sex-based standard range',
  ...
  bg: {
    ...
    evidenceKeys: {
      ...
      sex_needed_for_standard_range: 'нужен е пол за диапазон според стандарта',
  ...
  it: {
    ...
    evidenceKeys: {
      ...
      sex_needed_for_standard_range: 'sesso necessario per il range standard',
