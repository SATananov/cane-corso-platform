...
const copyByLocale: Record<string, PublicRegistryTrustCopy> = {
  ...
  bg: {
    ...
    title: 'Как да се чете този профил в Регистъра',
    description:
      'Тази публична страница е доверено представяне в Регистъра. Тя свързва Регистър, USG сертификат, проверка и сигналите от общността, без да ги смесва като едно решение.',
    registry: 'Registro',
    ...
    votes: 'гласа',
    openVerify: 'Отвори проверката',
    openCertificate: 'Отвори сертификата',
    lanes: {
      registry: 'Публикувана идентичност в Регистъра',
      registryDescription: 'Cane Corso има одобрено публично присъствие в Регистъра с публични снимки и основна идентичност.',
      ...
      certificateDescription: 'USG сертификат се показва само когато е издаден. Публикация в Регистъра не е същото като сертифициране.',
      community: 'Сигнал от общността',
      communityDescription: 'Оценката от общността е социална обратна връзка и не заменя официалния администраторски или сертификатен слой.',
  ...
  it: {
    ...
    title: 'Come leggere questo profilo nel Registro',
    description:
      'Questa pagina pubblica è una presentazione nel Registro affidabile. Collega Registro, certificato USG, verifica e segnali della comunità senza confonderli in una sola decisione.',
    registry: 'Registro',
    assessment: 'Valutazione amministrativa',
