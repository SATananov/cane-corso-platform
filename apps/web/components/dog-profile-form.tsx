...
const imageUploadCopy = {
  ...
  bg: {
    ...
    processing: 'Подготвям изображенията...',
    downloadPreview: 'Покажи USG изображение',
    download: 'Изтегли USG изображение',
