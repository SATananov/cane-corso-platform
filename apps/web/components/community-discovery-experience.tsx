...
const copyByLocale = {
  ...
  bg: {
    eyebrow: 'Глобално откриване в екосистемата',
    title: 'Намери правилния Cane Corso път, преди да отвориш конкретен запис',
    intro:
      'Общността е discovery слой: полезни публични маршрути, предложения от собственици, партньорски услуги, места, събития, транспорт, нов дом и редакционно съдържание. Този слой остава ясно отделен от официалния регистър и сертификатната authority.',
    stats: ['Публикувани след преглед', 'Държави в каталога', 'Отличени от админ'],
    submit: 'Изпрати през членската зона',
    guide: 'Виж правилата на общността',
    lanes: [
      ['Осиновяване / Нов дом', 'Спокоен модериран път, когато Cane Corso има нужда от по-сигурна и по-добра среда.'],
      ['Изгубени / намерени', 'Бъдещ публичен сигнал за спешна помощ от общността, без да замества админ проверката.'],
      ...
      ['Pet-friendly места', 'Ресторанти, магазини, паркове и обществени места, които могат безопасно да приемат Cane Corso.'],
      ['Малки Cane Corso / разплод / подбор', 'Бъдещ модериран discovery слой за развъждане и подбор, без смесване със сертификати.'],
    ...
    boundaries: [
      ...
      'Популярността и предложенията от общността никога не заменят официалната authority.',
    ],
  },
  it: {
