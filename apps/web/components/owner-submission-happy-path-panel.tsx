...
const happyPathCopy = {
  en: {
    ...
    description:
      'Use this as a short checklist after the form. First save the profile, then submit it for review. Publication, certificate, and gallery selection remain separate administrator decisions.',
    ...
    steps: {
      ...
      submission: ['Send for review', 'When the profile is ready, submit it to the administrator.'],
      admin: ['Administrator decision', 'Approval, publication, certificate, and gallery selection are handled separately by the administrator.'],
    },
    states: {
      ready: 'Ready',
  ...
  bg: {
    ...
    description:
      'Това е кратък чеклист след формата. Първо запази профила, после го изпрати за преглед. Публикуването, сертификатът и галерията остават отделни решения на администратор.',
    ...
    steps: {
      ...
      submission: ['Изпрати за преглед', 'Когато профилът е готов, изпрати го към администратор.'],
      admin: ['Решение от администратор', 'Одобрението, публикуването, сертификатът и изборът за галерия се правят отделно от администратор.'],
    },
    states: {
      ready: 'Готово',
      ...
      waiting: 'Изчаква',
      active: 'Активно',
      locked: 'Стъпка на администратор',
      saving: 'Записване...',
  ...
  it: {
    ...
    description:
      'Usa questo breve controllo dopo il modulo. Prima salva il profilo, poi invialo alla revisione. Pubblicazione, certificato e galleria restano decisioni separate dell’amministratore.',
    ...
    steps: {
      ...
      submission: ['Invia alla revisione', 'Quando il profilo è pronto, invialo all’amministratore.'],
      admin: ['Decisione amministratore', 'Approvazione, pubblicazione, certificato e scelta galleria sono gestiti separatamente dall’amministratore.'],
    },
    states: {
      ready: 'Pronto',
