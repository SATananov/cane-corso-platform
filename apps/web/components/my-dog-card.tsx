...
export function MyDogCard({ dog }: MyDogCardProps) {
  ...
  const workspaceCopy = {
    en: {
      ...
      adminTitle: 'Revisione amministratore',
    ...
    bg: {
      ...
      galleryCount: 'до 3 снимки от собственика',
      heroImageTitle: 'Основна профилна снимка',
      heroImageHint: 'Това е първата снимка, която собственикът вижда.',
      ...
      registryLayerOpen: 'Видими са само след публикуване от администратор.',
      registryLayerPending: 'Скрити са от Регистъра до публикуване от администратор.',
      usgGalleryLayer: 'USG Галерия',
      usgGalleryLayerHint: 'Само отделно избрани снимки от администратор.',
      ...
      adminTitle: 'Администраторски преглед',
      adminReview: 'Статус на прегледа',
      certificateTitle: 'USG сертификат',
      certificateIssued: 'Издаден отделно',
      certificatePending: 'Отделно решение от администратор',
    },
    it: {
      galleryEyebrow: 'Galleria Cane Corso',
      galleryTitle: 'Foto principali del profilo',
      galleryCount: 'fino a 3 foto del proprietario',
      heroImageTitle: 'Foto principale profilo',
      heroImageHint: 'È la prima immagine vista dal proprietario.',
      heroOwnerChip: 'Profilo proprietario',
      heroRegistryChip: 'Registro dopo pubblicazione',
      ...
      registryLayerOpen: 'Visibili solo dopo pubblicazione dell’amministratore.',
      registryLayerPending: 'Nascoste dal registro fino alla pubblicazione dell’amministratore.',
      usgGalleryLayer: 'Galleria USG',
      usgGalleryLayerHint: 'Solo selezione curata dall’amministratore.',
      ...
      assessmentEyebrow: 'Valutazione',
      communityTitle: 'Valutazione della comunità',
      ...
      certificatePending: 'Decisione separata dell’amministratore',
    },
  }[locale] ?? {
    galleryEyebrow: 'Cane Corso gallery',
    galleryTitle: 'Main profile photos',
