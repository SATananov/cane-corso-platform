...
const guideCopy: Record<Locale, GuideCopy> = {
  ...
  bg: {
    ...
    description:
      'Тези насоки държат официалния Cane Corso стандарт видим, но го превежда на по-спокоен и разбираем език за собственика. Помага на регистрираните потребители да подготвят по-добри профили и на админа да гледа по-подредено, без USG да се представя като FCI, ENCI, съдия или ветеринар.',
    ...
    cards: [
      {
        ...
        bullets: [
          ...
          'Страничната снимка помага най-много за силует, горна линия и пропорции.',
        ],
        href: '/faq#official-references',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Не превръщай една екранна снимка във финална присъда.',
          'Полезни са снимка отпред и снимка в профил.',
        ],
        href: '/knowledge',
        hrefLabel: 'Остани в Знания',
      },
      {
        eyebrow: '03 / Захапка',
        ...
        bullets: [
          ...
          'Ползвай я като помощен ориентир за преглед, не като публичен етикет за оценка.',
    ...
    sourceBody:
      'Използвай официалните текстове, когато точната формулировка има значение. USG ги обяснява, но не трябва да се представя сякаш ги заменя.',
    sourceLinks: [
...
const ownerPanelCopy: Record<Locale, QuickPanelCopy> = {
  ...
  bg: {
    ...
    bullets: [
      ...
      'Документите са по желание за админ преглед, не задължителна публична украса.',
    ],
    primaryHref: '/knowledge#usg-standard-guide',
    primaryLabel: 'Отвори USG насоките',
    secondaryHref: '/my-dogs/new',
...
const faqPanelCopy: Record<Locale, QuickPanelCopy> = {
  ...
  bg: {
    ...
    description: 'FAQ трябва да пази границата ясна: насоките помагат за ориентация, а официалните източници остават последният ориентир за точната формулировка.',
    bullets: [
      'Използвай насоките в Знания за по-спокойно обяснение към собственика.',
