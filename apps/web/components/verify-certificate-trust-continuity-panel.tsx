const trustLanes = [
  {
    ...
    description:
      'Verify потвърждава публичния резултат и връзката към официалния слой на Регистъра и сертификата.',
  },
  {
    title: 'USG Certificate',
    state: 'Официален документ',
    description:
      'Сертификатът е отделно администраторско решение и не се появява само защото Cane Corso е в Registry.',
  },
  {
    title: 'Регистър',
    state: 'Публикувана идентичност',
    description:
      'Профилът в Регистъра показва публично одобрена идентичност, снимки и основни данни.',
  },
  {
    title: 'Trust continuity',
    state: 'Една система',
    description:
      'Потребителят трябва ясно да разбира връзката Регистър → Проверка → Сертификат без смесване на решенията.',
  },
];
