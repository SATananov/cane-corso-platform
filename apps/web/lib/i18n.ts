  ...
  en: {
    ...
    form: {
      ...
      validation: {
        ...
        sexRequired: 'Choose sex when you know it before sending for review.',
  ...
  bg: {
    ...
    form: {
      ...
      validation: {
        ...
        sexRequired: 'Избери пол, когато го знаеш, преди да изпратиш профила за преглед.',
  ...
  it: {
    ...
    form: {
      ...
      validation: {
        ...
        sexRequired: 'Scegli il sesso quando lo conosci prima di inviare il profilo alla revisione.',
