...
export const dictionary: Record<Locale, any> = {
  en: {
    ...
    pages: {
      ...
      myDogs: {
        ...
        title: 'My Dogs',
        description:
          'Manage every Cane Corso profile from one premium private owner area. Drafts, edits, review, and publication stay connected in one clear flow.',
  ...
  bg: {
    ...
    common: {
      ...
      futureLabel: 'Бъдещ етикет',
      premiumStatement: 'ЕДИНСТВЕН ПО РОДА СИ',
      publicationPath: 'Път към публикация',
      currentBuildSlice: 'Текущ етап',
      emptyState: 'Празно състояние',
    ...
    form: {
      ...
      pedigree: {
        ...
        progressive: {
          ...
          replaceImage: 'Смени изображението',
          removeImage: 'Премахни изображението',
          imageLabel: 'Изображение на предеца',
          imageHint: 'Избери изображение от устройството си. То ще се покаже веднага във формата и в родословното дърво.',
