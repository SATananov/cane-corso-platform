...
const overviewCopy = {
  ...
  bg: {
    ...
    ownerGuideDescription: 'По-добрите снимки помагат на админа да разбере структура, баланс, профил и публично представяне преди публикуване.',
    ...
    helperDescription: 'Помощникът за стандарта е read-only насока за преглед, не автоматична оценка.',
  ...
  it: {
    ...
    description: 'Un layer educativo premium che trasforma le proporzioni ufficiali dello standard in guida chiara per proprietari e revisione admin, senza diventare giudizio automatico.',
    ...
    ownerGuideDescription: 'Foto migliori aiutano l’admin a capire struttura, equilibrio, profilo e presentazione pubblica prima della pubblicazione.',
    ...
    helperTitle: 'Confine helper admin',
    helperDescription: 'L’helper standard è guida read-only per review, non punteggio automatico.',
    helperWarning: 'Visibilità USG, certificati e fiducia registry restano decisioni umane admin.',
  },
} as const;
