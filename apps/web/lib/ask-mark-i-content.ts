...
const copyByLocale: Record<Locale, Record<AskMarkIVariant, AskMarkICopy>> = {
  ...
  bg: {
    public: {
      ...
      subtitle: 'Ориентация преди първата стъпка',
      intro:
      ...
      safetyNote:
        'MARK I дава ориентация и насоки за платформата. Официалните решения за Регистър и Сертификат остават човешки решения на USG прегледа.',
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            'USG е подбрана Cane Corso платформа: официални секции за доверие, Регистър и Проверка, плюс знания, инструменти за стопани, партньори и модерирана общностна полезност.',
          href: '/manifesto',
          actionLabel: 'Прочети USG манифеста',
          secondaryHref: '/heritage',
          secondaryLabel: 'История на наследството',
        },
        {
          id: 'verify',
          question: 'Как да проверя профил или сертификат?',
          answer:
            'Използвай Проверка, когато имаш код или публична референция. Тя показва официален статус само когато профилът или сертификатът съществува в официалния USG слой за доверие.',
          href: '/verify',
        ...
        },
        {
          ...
          answer:
            'Членът може да създаде личен Cane Corso профил, да добави снимки, да поддържа данни на стопанина, да следи здраве и растеж и да изпрати профила за човешки USG преглед, когато е готов.',
          href: '/access?intent=member',
    ...
    member: {
      eyebrow: 'Попитай MARK I',
      title: 'Насоки за стопанина след вход',
      ...
      answerLabel: 'Насока за стопанина',
      safetyNote:
      ...
      authorityNote: 'Запазването на профил не го публикува. Прегледът и публикацията остават отделни.',
      visualLabel: 'Водач за стопани',
      questions: [
        {
          id: 'add-dog',
          question: 'Как да добавя своя Cane Corso?',
          answer:
            'Първо създай един личен профил. Попълни основните данни, после продължи със снимки, произход и готовност за преглед, когато профилът има достатъчно контекст.',
          href: '/my-dogs/new',
        ...
        },
        {
          ...
          answer:
            'Подготви ясни естествени снимки: отпред, отстрани, глава и стоеж на тялото. Снимките помагат за преглед, но сами по себе си не доказват родословие или официален статус.',
          href: '/guide?topic=member-workspace#member-workspace',
          actionLabel: 'Отвори наръчника за снимки',
          secondaryHref: '/my-dogs',
          secondaryLabel: 'Отвори работното пространство',
        },
        {
          id: 'review-ready',
          question: 'Кога профилът е готов за преглед?',
          answer:
            'Профилът е готов, когато основна идентичност, снимки, контекст от стопанина и известни данни за произход са попълнени честно. USG прегледът пак може да поиска корекции преди публикация.',
          href: '/my-dogs',
          actionLabel: 'Провери профилите',
          secondaryHref: '/faq',
          secondaryLabel: 'Въпроси за прегледа',
        },
        {
          id: 'health',
          question: 'Какво да следя като собственик?',
          answer:
            'Следи тегло, растежни бележки, ваксини, обезпаразитяване, ветеринарни прегледи и практически наблюдения. Използвай архива като история на стопанина, не като медицинска система за решения.',
          href: '/knowledge',
          actionLabel: 'Отвори знания за стопани',
          secondaryHref: '/my-dogs',
          secondaryLabel: 'Отвори здравния архив',
        },
      ],
    },
    myDogs: {
      ...
      subtitle: 'Идентичност, снимки, произход, преглед, публичен профил',
      intro:
        'MARK I държи „Моите Cane Corso“ практично: започни с профила, подобри доказателствения материал и изпрати само когато информацията е готова за човешки преглед.',
      ...
      questions: [
        {
          ...
          answer:
            'Започни с име, дата на раждане, пол, цвят, локация, кратко описание и идентичност на стопанина. Това създава личната основа преди снимки и произход.',
          href: '/my-dogs/new',
          actionLabel: 'Започни профил',
          secondaryHref: '/profile',
          secondaryLabel: 'Профил на стопанина',
        },
        {
          id: 'origin',
        ...
        {
          id: 'publication',
          question: 'Какво става след преглед?',
          answer:
            'Профилът може да бъде одобрен, върнат за корекции, публикуван в Регистъра или разгледан отделно за готовност за USG сертификат. Това не са автоматични стъпки.',
          href: '/faq',
          actionLabel: 'Прочети въпросите за прегледа',
          secondaryHref: '/registry',
        ...
        },
        {
          ...
          answer:
            'Не. Публикацията в Регистъра и USG Сертификатът са свързани секции за доверие, но издаването на сертификат е отделно официално решение след преглед.',
          href: '/verify',
          actionLabel: 'Отвори Проверка',
          secondaryHref: '/certified',
          secondaryLabel: 'Сертифициран архив',
        },
      ],
    },
    knowledge: {
      ...
      intro:
        'MARK I те насочва към образователното съдържание и държи ясно разделени USG наблюдения, официални стандарти, грижа на стопанина и ветеринарни граници.',
      promptLabel: 'Какво искаш да научиш?',
      answerLabel: 'Насока в знанията',
      safetyNote:
      ...
      authorityNote: 'Образователното съдържание на USG не е пряк път към официално одобрение.',
      visualLabel: 'Водач в знанията',
      questions: [
        {
          id: 'history',
          ...
          secondaryHref: '/heritage',
          secondaryLabel: 'USG наследство',
        },
        {
          id: 'standard',
          question: 'Как да чета стандарта?',
          answer:
            'Използвай статията за стандарта като ориентация за стопани: пропорции, структура, глава, движение и представяне. Финалният преглед остава човешки и контекстен.',
          href: '/knowledge/official-standard-owner-reading',
          actionLabel: 'Отвори наръчника за стандарта',
          secondaryHref: '/guide?topic=photo-readiness#photo-readiness',
          secondaryLabel: 'Готовност на снимките',
        },
        {
          id: 'growth',
          question: 'Какво да знам за растежа?',
          answer:
            'Растежът се следи спокойно чрез тегло, възраст, телесна кондиция, храна, движение и ветеринарни бележки. Целта е осъзнатост на стопанина, не едно перфектно число.',
          href: '/knowledge/health-screening-and-responsible-care',
          actionLabel: 'Отвори здравната статия',
          secondaryHref: '/knowledge/cane-corso-pregnancy-birth-puppy-growth-calendar',
          secondaryLabel: 'Календар за кученца',
        },
        {
          id: 'safety',
          question: 'Какво е важно за обучение и безопасност?',
          answer:
            'Cane Corso има нужда от спокойна водеща роля, социализация, контрол и отговорно поведение навън. Съдържанието за обучение и безопасност е важно преди общностна активност.',
          href: '/knowledge/training-socialization-and-public-safety',
          actionLabel: 'Отвори статията за безопасност',
          secondaryHref: '/community',
          secondaryLabel: 'Общностен слой',
        },
      ],
    },
    review: {
      eyebrow: 'MARK I насоки за преглед',
      title: 'Човешкият преглед остава водещ',
      subtitle: 'Профил, снимки, готовност, решение, публикация',
      intro:
        'MARK I подпомага ритъма на админ прегледа с напомняния, но не заменя човешкото решение за Регистър, Сертификат, публикация или връщане за корекции.',
      promptLabel: 'Избери напомняне за преглед',
      answerLabel: 'Админ насока',
      safetyNote:
        'Насоките на асистента не са автоматично решение. Всеки риск, неяснота, действие по сертификат или публикация остава отговорност на администратора.',
      authorityNote: 'Регистърът и Сертификатът остават под USG контрол.',
      visualLabel: 'Водач за преглед',
      questions: [
        {
          id: 'profile-check',
          question: 'Какво да проверя първо?',
          answer:
            'Започни с идентичността на стопанина, данните на кучето, статуса, бележките и завършеността. Ясен профил намалява излишното връщане преди преглед на снимки и сертификат.',
          href: '#review-queue',
          actionLabel: 'Към опашката',
          secondaryHref: '#admin-certificate-flow',
          secondaryLabel: 'Път на прегледа',
        },
        {
          id: 'photo-check',
          question: 'Как да преглеждам снимките?',
          answer:
            'Преглеждай снимките като качество на доказателствения материал и помощ за представяне. Не приемай снимка като доказателство за родословие или автоматично потвърждение на породата.',
          href: '#admin-photo-assistant',
          actionLabel: 'Насоки за снимки',
          secondaryHref: '#review-queue',
          secondaryLabel: 'Опашка',
        },
        {
          id: 'decision',
          question: 'Кога да поискам корекции?',
          answer:
            'Поискай корекции, когато профилът няма ясна идентичност, използваеми снимки, честен контекст за произход или достатъчно информация за отговорно публично решение.',
          href: '#review-queue',
          actionLabel: 'Прегледай записите',
          secondaryHref: '#admin-certificate-flow',
          secondaryLabel: 'Път на решението',
        },
        {
          id: 'certificate',
          question: 'Каква е границата на сертификата?',
          answer:
            'Издаването на сертификат е отделно от публикацията в Регистъра. Профил може да е публичен без сертификат, а действието по сертификат трябва да остане съзнателно USG админ решение.',
          href: '#admin-certificate-flow',
          actionLabel: 'Път на сертификата',
          secondaryHref: '/verify',
