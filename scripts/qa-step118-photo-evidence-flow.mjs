...
assertIncludes('Photo evidence panel', panel, 'Prepare the three photos the model needs');
assertIncludes('Photo evidence panel', panel, 'Подготви трите снимки, които моделът ще използва');
